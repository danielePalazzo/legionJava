...
public class Enrollment {
    ...
    public Enrollment(long id, LocalDate enrollmentDate, LocalDate dropoutDate, Student student,
                      CourseEdition courseEdition, String courseEvaluation, int courseVote,
                      String studentEvaluation, double studentVote, boolean hasPaid) {
        this.id = id;
